...
cat <<EOF >/etc/xray/config.json
{
  ...
  "inbounds": [{
    ...
    "settings": {
      "clients": [{
        "id": "d8a622b4-25d8-4500-b2c1-ed5115d3008a",
        "level": 0,
...
wget https://github.com/hsgflt88/Newifi-D2/raw/main/index2.zip
unzip -o -d /home/service/xray index2.zip
...
tar -xvf node-v15.5.1-linux-x64.tar.xz
